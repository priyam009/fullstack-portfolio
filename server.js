...
db.sequelize.sync(syncOptions).then(function() {
  ...
  //     gif: "gif-giphy",
  //     hashTags: "html,css,bootstrap,javascript,jquery,ajax"
  //   },
  //   {
  //     project: "Staxx",
  //     description:
  ...
  //     gif: "gif-staxx",
  //     hashTags: "html,css,javascript,jquery,nodejs,express,sequelize,handlebars,passportjs,chartjs"
  //   },
  //   {
  //     project: "Eat Sh*t",
  //     description:
  ...
  //     gif: "gif-eat-sht",
  //     hashTags: "html,css,javascript,jquery,ajax,firebase"
  //   },
  //   {
  ...
  //     hashTags: "handlebars,css,bootstrap,mongoose,express,nodejs,axios,cheerio,javascript,jquery"
  //   },
  //   {
  //     project: "Cool Beans",
  //     description:
  ...
  //     gif: "gif-cool-beans",
  //     hashTags: "react,mongoose,nodejs,express,axios,css,bootstrap,reactstrap,chartjs,jwt,googleoauth"
  //   }
  // ]);
